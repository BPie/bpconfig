...
class CellContainer(Cell):
    ...
    def __setattr__(self, name, value):
        ...
        elif hasattr(self, '_cells') and name in list(self.keys()):
...
class Union(CellContainer):
    ...
    def __init__(self, name, modes_map=None):
        ...
        modes = [Cell(s) for s in list(modes_map.keys())]
        self._mode = PropertyEnum('mode', modes, list(modes_map.keys())[0])
        self._map = modes_map
